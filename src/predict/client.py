...
from src.predict.schemas import PredictionClientRequest, PredictionClientResponse, BatchPredictionClientRequest, BatchPredictionClientResponse
...
class PredictionClient:
    ...
    def predict(self, request: PredictionClientRequest) -> PredictionClientResponse:
        try:
            response = requests.post(f"{self.base_url}/prediction/predict", json=request.model_dump(mode="json"), headers={"Content-Type": "application/json"})
