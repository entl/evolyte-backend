...
def get_pv_performance(data: Annotated[PVGISGridConnectedTrackingPVSystemsRequest, Query()],
...
def get_offgrid_pv(data: Annotated[PVGISOffGridRequest, Query()],
                   pvgis_service: PVGISServiceDep):
...
def get_monthly_radiation(data: Annotated[PVGISMonthlyRadiationRequest, Query()],
                          pvgis_service: PVGISServiceDep):
...
def get_daily_radiation(data: Annotated[PVGISDailyRadiationRequest, Query()],
                        pvgis_service: PVGISServiceDep):
...
def get_hourly_radiation(data: Annotated[PVGISHourlyRadiationRequest, Query()],
                         pvgis_service: PVGISServiceDep):
...
def get_tmy_data(data: Annotated[PVGISTMYRequest, Query()],
                 pvgis_service: PVGISServiceDep):
